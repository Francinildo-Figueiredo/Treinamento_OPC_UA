    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var config = new ApplicationConfiguration()
            {
                ...
                ApplicationUri = Utils.Format(@"urn:{0}:EvaporadorPlantaClient", System.Net.Dns.GetHostName()),
                ApplicationType = ApplicationType.Client,
                SecurityConfiguration = new SecurityConfiguration
                {
                    ApplicationCertificate = new CertificateIdentifier { StoreType = @"Directory", StorePath = @"%CommonApplicationData%\OPC Foundation\CertificateStores\MachineDefault", SubjectName = "EvaporadorPlantaClient" },
            ...
            var selectedEndpoint = CoreClientUtils.SelectEndpoint("opc.tcp://laptop-0rgvdin2:26543/EvaporadorPlanta", useSecurity: true);
